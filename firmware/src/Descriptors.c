// This version of Descriptors.c has been heavily modified from the original demo in Dean Camera's LUFA repository.
...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM VolControlReport[] =
{
	...
	.HID_VolControlHID =
		{
			...
			.HIDReportLength        = sizeof(VolControlReport)
		},
	...
	.HID_ReportINEndpoint =
		{
			...
			.EndpointAddress        = VOLCONTROL_HID_EPADDR,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = VOLCONTROL_HID_EPSIZE,
...
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"volcon");
                                    ...
                                    const void** const DescriptorAddress)
{
	...
	switch (DescriptorType)
	{
		...
		case DTYPE_String:
			...
			break;
		case HID_DTYPE_HID:
			Address = &ConfigurationDescriptor.HID_VolControlHID;
			Size    = sizeof(USB_HID_Descriptor_HID_t);
			break;
		case HID_DTYPE_Report:
			Address = &VolControlReport;
			Size    = sizeof(VolControlReport);
			break;
	}
